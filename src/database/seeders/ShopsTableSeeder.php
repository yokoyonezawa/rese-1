...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $sushiGenreId = DB::table('genres')->where('name', '寿司')->value('id');
        $yakinikuGenreId = DB::table('genres')->where('name', '焼肉')->value('id');
        $izakayaGenreId = DB::table('genres')->where('name', '居酒屋')->value('id');
        $italianGenreId = DB::table('genres')->where('name', 'イタリアン')->value('id');
        $ramenGenreId = DB::table('genres')->where('name', 'ラーメン')->value('id');

        $tokyoAreaId = DB::table('areas')->where('name', '東京都')->value('id');
        $osakaAreaId = DB::table('areas')->where('name', '大阪府')->value('id');
        $fukuokaAreaId = DB::table('areas')->where('name', '福岡県')->value('id');
